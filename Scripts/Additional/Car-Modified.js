//If you're using Unity's Car Tutorial:
//Please copy all modifcations from this script, which are market with "AI Driver Toolkit modification" into in the Car.js - Script

var playerCar = true; //AI Driver Toolkit modification - new variable
...
var steer : float = 0;//AI Driver Toolkit modification - change visibility from private to public
...
function GetInput()
{
	//AI Driver Toolkit modification - new if clause
	if(playerCar) 
	{
